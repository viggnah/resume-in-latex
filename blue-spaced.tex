...
\headertype{\email}{\phone}{\website}{\github}{\linkedin}{} % Set the order of items here, empty braces reqd at end to have 6
% {\nic}{\address}
...
\section{\faIndustry}{Experience}
  ...
  \resumeEntryStart
    ...
    {Responsibilities}{}
    \resumeItemListStart
      \resumeItem {Technical selling of API Management, Integration, and Identity \& Access Management (IAM)}
      \resumeItem {Demos}
  ...
  \resumeEntryStart
    ...
    {Achievements}{}
    \resumeItemListStart
      \resumeItem {Optimised data processing in Spark to improve delivery time by 60\% to 80\% on two separate flows}
...
\section{\faFlask}{Projects}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      \resumeItem {Final year project. Won TCS Best Project Award for best final year project. Published as an IEEE white paper.}
